...
if (isset($comentariosUsuario) && $comentariosUsuario=="") {?>
<br>
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  <symbol id="check-circle-fill" fill="currentColor" viewBox="0 0 16 16">
    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
...
<html lang="es">
  ...
  <body>
    ...
    <h4>Su inscripción se realizó de forma exitosa.</h4>
    </div>
    <br>
    <div class="container fluid d-flex justify-content-center ">
    <br> 
    ...
    <br>
    <h6 class="card-subtitle mb-2 text-muted"><?php echo $emailUsuario ?> </h6>
    <h6 class="card-subtitle mb-2 text-muted"><?php echo $fechaAltaUsuario ?></h6>
    <p class="card-text"><p class="text-decoration-underline">Tema:</p><?php echo " ". $comentariosUsuario?></p>
    ...
    <div class="card-header text-center">
     La Organización se contactará al mail registrado.
    </div> 
    </div>
    </div>
    </div>
...
/*if ( $flag == 0 ){
require 'funcs/insertar.php';
} else { echo "error  -> verifique los datos cargados";}
*/
require 'funcs/insertar.php';
